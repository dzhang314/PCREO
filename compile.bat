...
ifort /Qmkl /I"%MKLROOT%"\include /Qopt-report:5 /warn:all /wrap-margin- /o bin\pcreo_sphere_bfgs_sym_hc /fast src\pcreo_sphere_bfgs_sym_hc.f90 mkl_intel_lp64.lib mkl_sequential.lib mkl_core.lib
